...
**Output file:** `.claude/skills/ai-job-search/cover_letters/cover_<company>_<role>.tex`
**Compile with:** XeLaTeX (cover.cls requires fontspec)
**Font directory:** `.claude/skills/ai-job-search/cover_letters/OpenFonts/fonts/`
