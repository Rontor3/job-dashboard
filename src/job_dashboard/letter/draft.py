...
def _build_prompt(
    ...
    return (
        ...
        "GOAL: make it SPECIFIC, not generic. A hiring manager should feel you "
        "actually know what their team builds. Reference at least ONE concrete "
        "thing the company has built / shipped / is working on — a real "
        "technical project, ML/data system, product launch, or announced "
        "initiative — taken ONLY from VERIFIED COMPANY FACTS below, and connect "
        "it to the candidate's real experience. Ban generic filler like "
        "'committed to leveraging data and technology' or 'innovative "
